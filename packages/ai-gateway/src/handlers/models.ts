...
const CURATED_MODELS: ModelEntry[] = [
  ...
  },
  {
    ...
    owned_by: 'vertex-maas',
    name: 'GLM-5.1',
    description: '#1 open-source coding model, 754B MoE',
    tags: ['free', 'coding', 'reasoning'],
    free: true,
    context_window: 128000,
    best_for: ['coding', 'reasoning', 'tool use'],
  ...
  },
  {
    ...
    owned_by: 'vertex-maas',
    name: 'MiniMax M2.7',
    description: 'near-Opus quality, 230B MoE',
    tags: ['free', 'reasoning'],
    free: true,
    context_window: 128000,
  ...
  // ── Confidential inference (Tinfoil — secure enclaves) ──
  {
    ...
    description: 'runs in secure enclaves — your data stays encrypted, even from the provider',
