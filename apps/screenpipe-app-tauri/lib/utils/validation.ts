...
export const settingsStoreSchema = z.object({
  ...
  semanticContextPreference: z.boolean().nullable().optional(),
  semanticContextRemoteDefault: z.boolean().optional(),
  semanticContextRemoteForceDisabled: z.boolean().optional(),
