---
title: "MCP server setup for Claude, Cursor, and other AI tools"
sidebarTitle: "mcp server"
description: "Set up screenpipe as a Model Context Protocol server so Claude Desktop, Cursor, and other AI assistants can search your screen history and audio transcripts."
icon: "server"
---
