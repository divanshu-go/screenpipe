...
description: "Remove names, emails, phone numbers, addresses, and account numbers from your screen data before it reaches the AI. Runs inside a confidential-compute enclave you can verify."
icon: "shield-halved"
---
...
```
Before:  "email louis.beaumont@gmail.com about the invoice, call me at 555-1234"
