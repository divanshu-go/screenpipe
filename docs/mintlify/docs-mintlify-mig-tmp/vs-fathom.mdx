...
yes. screenpipe captures everything Fathom does (meeting audio and transcription) plus your entire screen activity 24/7. it runs locally, is open source, and costs $400 one-time vs Fathom's $19–24/month per user. the trade-off: Fathom has native CRM sync (Salesforce, HubSpot) which screenpipe handles through custom pipes.
...
Fathom costs $19–24/user/month. a 10-person team pays $2,280–$2,880/year for meeting transcription only. screenpipe costs $400 one-time for screen + audio + meetings + API access with no per-user fees. screenpipe breaks even at around 17–21 months for a single user.
